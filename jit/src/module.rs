...
impl ImportType {
    pub fn module(&self) -> &str {
        unsafe { crate::name_to_str(ffi::wasm_importtype_module(self.raw)) }
    }

    pub fn name(&self) -> &str {
        unsafe { crate::name_to_str(ffi::wasm_importtype_name(self.raw)) }
    }
...
impl ExportType {
    pub fn name(&self) -> &str {
        unsafe { crate::name_to_str(ffi::wasm_exporttype_name(self.raw)) }
    }
}
